...
function displayCategories(arr){
    ...
    for(let i=0;i<arr.length;i++){
        cartoona+=`<div class="col-md-3">
        <div onclick="getCategoryMeals('${arr[i].strCategory}')" class="meals position-relative overflow-hidden rounded-2">
...
function displayIngredients(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3">
                <div onclick="getIngredientsMeals('${arr[i].strIngredient}')"  class="rounded-2 text-center meals">
